...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in {
            ...
            RepNCSPELAN4, SPPELAN, EfficientChannelAttention, ECABottleneck, CBAMBottleneck, CBAMC4}:
            c1, c2 = ch[f], args[0]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='./detect/yolov9-e-9head-cbamc4.yaml', help='model.yaml')
